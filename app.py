...
class App(ctk.CTk):
    def __init__(self):
        ...
        # Define clean Apple/Fluent inspired style constants
    ...
    def setup_header(self):
        ...
        title_label = ctk.CTkLabel(title_container, text="AI DocPrep", font=ctk.CTkFont(family=self.font_family, size=24, weight="bold"))
        title_label.pack(side="left")
        
        version_label = ctk.CTkLabel(title_container, text="v1.1.0", font=ctk.CTkFont(family=self.font_family, size=11), text_color="gray")
        ...
        self.status_label = ctk.CTkLabel(header_frame, text="System Ready", font=ctk.CTkFont(family=self.font_family, size=12, slant="italic"), text_color="gray")
    ...
    def update_drop_zone_view(self):
        ...
        if not self.selected_path:
            ...
            self.drop_zone.configure(fg_color=self.card_bg, border_width=1, border_color=("gray85", "gray25"))
            
            icon_label = ctk.CTkLabel(self.drop_zone, text="📥", font=ctk.CTkFont(family=self.font_family, size=36))
            icon_label.pack(pady=(20, 2))
            
            mode_text = "File" if self.browse_mode_var.get() == "File Mode" else "Folder"
            primary_label = ctk.CTkLabel(self.drop_zone, text=f"Drag & Drop a {mode_text} Here", font=ctk.CTkFont(family=self.font_family, weight="bold", size=13))
            primary_label.pack(pady=1)
            
            secondary_label = ctk.CTkLabel(self.drop_zone, text="or click anywhere to browse...", font=ctk.CTkFont(family=self.font_family, size=10), text_color="gray")
            ...
            icon_label = ctk.CTkLabel(card_content, text=card_icon, font=ctk.CTkFont(family=self.font_family, size=32))
            icon_label.pack(side="left", padx=(0, 12))
            
            text_frame = ctk.CTkFrame(card_content, fg_color="transparent")
            text_frame.pack(side="left", fill="both", expand=True)
            
            name_label = ctk.CTkLabel(text_frame, text=os.path.basename(self.selected_path), font=ctk.CTkFont(family=self.font_family, weight="bold", size=12), anchor="w")
            ...
            path_label = ctk.CTkLabel(text_frame, text=display_path, font=ctk.CTkFont(family=self.font_family, size=10), text_color="gray", anchor="w")
    ...
    def setup_action_button(self):
        ...
        self.stop_btn = ctk.CTkButton(
            action_frame, 
            text="Stop", 
            fg_color=("#d9534f", "#e05d58"), 
            hover_color=("#c9302c", "#c22b27"), 
            font=ctk.CTkFont(family=self.font_family, size=16, weight="bold"), 
            height=50, 
            corner_radius=6,
    ...
    def setup_log_area(self):
        ...
        ctk.CTkLabel(
            log_frame, 
            text="Activity Log", 
            font=ctk.CTkFont(family=self.font_family, weight="bold", size=12)
    ...
    def open_settings(self):
        ...
        settings_win.configure(fg_color=self.window_bg)
        ...
        # Configure tab fonts
        tabview._segmented_button.configure(font=ctk.CTkFont(family=self.font_family, size=12, weight="bold"))
        ...
        ctk.CTkLabel(
            ...
            font=ctk.CTkFont(family=self.font_family, weight="bold", size=14)
        ...
        ctk.CTkLabel(
            ...
            font=ctk.CTkFont(family=self.font_family, weight="bold", size=14)
        ).pack(padx=10, pady=(18, 8), anchor="w")
        
        chk_yaml = ctk.CTkCheckBox(
            scroll_output, 
            text="Inject YAML Frontmatter", 
            variable=self.yaml_var,
            font=ctk.CTkFont(family=self.font_family, size=12),
            fg_color=self.accent_color,
            hover_color=self.accent_hover
        )
        ...
        chk_toc = ctk.CTkCheckBox(
            scroll_output, 
            text="Generate Table of Contents (Combined Mode)", 
        ...
        rb_copy = ctk.CTkRadioButton(
            scroll_output, 
            text="Create a copy (e.g., file (1).md)", 
            variable=self.overwrite_var, 
            value="copy",
            font=ctk.CTkFont(family=self.font_family, size=12),
            fg_color=self.accent_color,
        ...
        ctk.CTkLabel(
            scroll_privacy, 
            text="PII Redaction Options", 
            font=ctk.CTkFont(family=self.font_family, weight="bold", size=14)
        ).pack(padx=10, pady=(10, 8), anchor="w")
        
        # Privacy Mode Checkbox
        chk_redact = ctk.CTkCheckBox(
            scroll_privacy, 
            text="Enable Privacy Mode (Auto-Redact PII)", 
            variable=self.redact_var, 
            font=ctk.CTkFont(family=self.font_family, size=12),
            fg_color=self.accent_color,
            hover_color=self.accent_hover,
            command=lambda: toggle_redact_widgets()
        )
        ...
        engine_menu = ctk.CTkOptionMenu(
            ...
            dropdown_font=ctk.CTkFont(family=self.font_family, size=11),
        ...
        engine_help_label = ctk.CTkLabel(
            scroll_privacy, 
            text="", 
            font=ctk.CTkFont(family=self.font_family, size=11, slant="italic"), 
            text_color="gray50",
            wraplength=380,
            justify="left"
        )
        ...
        terms_label = ctk.CTkLabel(
            scroll_privacy, 
            text="Custom Terms to Redact (one per line):", 
            font=ctk.CTkFont(family=self.font_family, size=12, weight="bold")
        )
        terms_textbox = ctk.CTkTextbox(
            scroll_privacy, 
            height=90, 
            width=400, 
            fg_color=self.card_bg,
    ...
    def run_async(self, func, *args):
        ...
        self.status_indicator.configure(fg_color=self.accent_color)
